...
[
    {
        ...
        "content": "현대모비스에서 1차면접을 탈락한 후 한두달도 되지 않아 동일 직무들이 다시 수시채용이 올라왔습니다. 공고가 다시 뜬 기간이 너무 짧아서 동일 직무를 지원해도 확률이 있을지에 대해서 고민이 됩니다. \n\n제 흥미와 역량이 이전 지원 직무에 적합하지만 끼워맞춘다면 다른 직무에 지원할수도 있긴 합니다.. 하지만 썩 내키지 않아서 계속 고민이 되는데 조언해주시면 감사하겠습니다!",
        "anwsers": [
            {
                "id": 1,
                "company": "삼성전기",
        ...
        "anwsers": [
            {
                "id": 2,
                "company": "대원제약",
                "content": "네 입사하게 되면 저 업무를 모두다 하게 됩니다.\n애초에 어지간히 큰회사가 아닌 이상은 RA직무 신입의 경우 1명 아니면 2명을 뽑기 때문에 입사동기가 있기도 힘들어요.\n제품 하나 맡아서 기획개발부터 허가발매까지 쭉이어 나가게 됩니다. 본인이 PM이 되어서 끌고 가신다고 보면 됩니다.\n허가변경 등 사후관리 업무는 병행하는것이구요. 규정 팔로우업 하는것도 기본인 것이구요.",
                "question_id": 2
            }
        ]
    },
        ...
        "anwsers": [
            {
                "id": 7,
                "company": "하나은행",
                "content": "금융권에 대한 관심을 보여주는 것에는 로열티와 관심을 표현하면 됩니다.",
                "question_id": 3
            },
            {
                "id": 8,
                "company": "동아제약",
                "content": "제약회사에 입사하기 위해서는 어쩌구 저쩌구 저쩌구 저쩌구가 필요합니다,",
                "question_id": 3
            }
        ]
    },
    {
        ...
        "company": "오징어",
        "position": "모든직무",
        "title": "LG화학 1차 면접탈락 후 동일직무 지원해도 될까요?",
